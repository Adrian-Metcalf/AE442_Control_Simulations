...
function rocket = getRocketTradeStudy3(motor, mass, alt0, length, diameter)
...
rocket.structure.dryMass = rocket.fin.numFins*rocket.structure.finMass + ...
    rocket.structure.tubeMass + rocket.structure.electronicsMass + ...
    rocket.structure.ballastMass + rocket.structure.epoxyMass + ...
    rocket.structure.legsMass + rocket.structure.gimbalMass;
...
rocket.y0 = [0 0 alt0 0 0 0 0 0*pi/180 0 0 0 0 motor.wetMass]';
